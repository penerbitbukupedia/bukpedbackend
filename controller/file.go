...
func UploadDraftBukuWithParamFileHandler(w http.ResponseWriter, r *http.Request) {
	...
	githubOrg := "penerbitbukupedia"
	githubRepo := "draft"
	pathFile := prj.Name + "/draft/" + hashedFileName + header.Filename[strings.LastIndex(header.Filename, "."):] // Append the original file extension
	replace := true
...
func UploadDraftBukuPDFWithParamFileHandler(w http.ResponseWriter, r *http.Request) {
	...
	githubOrg := "penerbitbukupedia"
	githubRepo := "draft"
	pathFile := prj.Name + "/pdf/" + hashedFileName + header.Filename[strings.LastIndex(header.Filename, "."):] // Append the original file extension
	replace := true
	...
	//update data profpic
	prj.DraftPDFBuku = "https://raw.githubusercontent.com/" + githubOrg + "/" + githubRepo + "/main/" + *content.Content.Path
	atdb.ReplaceOneDoc(config.Mongoconn, "project", bson.M{"_id": prj.ID}, prj)
...
func UploadSampulBukuPDFWithParamFileHandler(w http.ResponseWriter, r *http.Request) {
	...
	githubOrg := "penerbitbukupedia"
	githubRepo := "draft"
	pathFile := prj.Name + "/sampul/" + hashedFileName + header.Filename[strings.LastIndex(header.Filename, "."):] // Append the original file extension
	replace := true
	...
	//update data profpic
	prj.SampulPDFBuku = "https://raw.githubusercontent.com/" + githubOrg + "/" + githubRepo + "/main/" + *content.Content.Path
	atdb.ReplaceOneDoc(config.Mongoconn, "project", bson.M{"_id": prj.ID}, prj)
